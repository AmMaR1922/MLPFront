...
const translations = {
    en: {
        ...
        logoutButton: "Logout",
        UpdateHospitalH2: "Update Hospital",
        UpdateHospitalP: "Enter the hospital details below",
    ...
    ar: {
        ...
        UpdateHospitalH2: "تعديل مستشفي",
        UpdateHospitalP: " ادخل بيانات المستشفي في الاسفل",
...
function changeLanguage() {
    ...
    document.getElementById("UpdateHospitalH2").innerText = translation.UpdateHospitalH2;
    document.getElementById("UpdateHospitalP").innerText = translation.UpdateHospitalP;
    ...
    document.getElementById("ImageUrlLabel").innerText = translation.ImageUrlLabel;
    document.getElementById("UpdateFromBtn").innerText = translation.UpdateFromBtn;
    document.getElementById("closeFormBtn").innerText = translation.closeFormBtn;
